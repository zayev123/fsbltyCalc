# Generated by Django 3.2.7 on 2021-09-28 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.TextField(blank=True, null=True)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
                ('equipment_model_used', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='production_sections', to='feasibility_calculator.equipment')),
                ('labour_role_needed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='production_sections', to='feasibility_calculator.labour_plantoperatingcost')),
            ],
        ),
        migrations.CreateModel(
            name='ResearchPaper',
