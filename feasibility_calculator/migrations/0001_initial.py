# Generated by Django 3.2.7 on 2021-09-26 15:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_equipment_units_needed', models.IntegerField(default=0)),
                ...
                ('total_maintenance_down_time_fraction_per_hour', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ...
                ('maintenance_down_time_fraction_per_equipmentUnit_per_hour', models.DecimalField(decimal_places=4, default=0, max_digits=8)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
                ('remarks', models.TextField(blank=True, null=True)),
                ('technology', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipment_operating_costs', to='feasibility_calculator.availabletechnology')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.TextField(blank=True, null=True)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
                ('equipment_model_used', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='production_sections', to='feasibility_calculator.equipment')),
                ('labour_role_needed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='production_rate', to='feasibility_calculator.labour_plantoperatingcost')),
            ],
        ),
        migrations.CreateModel(
            name='ResearchPaper',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_hours_per_month', models.IntegerField(default=0)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
                ('remarks', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource_quantity_neede_per_EquipmentUnit_per_hour', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_replacement_cost_per_unit_per_hour_Rs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
