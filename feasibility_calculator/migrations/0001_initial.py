    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('working_days_per_year', models.DecimalField(decimal_places=6, default=365, max_digits=9)),
                ...
                ('line_operating_cost_per_hour_Rs', models.DecimalField(decimal_places=6, default=0, max_digits=16)),
                ...
                ('line_area_required_m2', models.DecimalField(decimal_places=6, default=0, max_digits=16)),
                ('max_ideal_amount_of_section_product_produced_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=16)),
                ('entire_maintenance_fraction_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=8)),
                ('amount_of_section_product_missed_per_hour_for_maintenance', models.DecimalField(decimal_places=6, default=0, max_digits=16)),
                ('net_amount_of_product_produced_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_maintenance_down_time_fractions_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=10)),
                ...
                ('maintenance_down_time_fractions_per_equipmentUnit_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=10)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
                ('remarks', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_line_production_hours_per_day_weekly_projection', models.DecimalField(decimal_places=6, default=0, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('working_days_per_year_for_this_line', models.DecimalField(decimal_places=6, default=0, max_digits=9)),
                ('working_hours_per_day_for_this_line', models.DecimalField(decimal_places=6, default=0, max_digits=8)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('reference', models.FileField(blank=True, null=True, storage=frzFeasibilityHandler.myStorage.OverwriteStorage(), upload_to='research_papers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenance_downTime_fraction_per_equipmentUnit_per_hour', models.DecimalField(decimal_places=6, default=0, max_digits=6)),
