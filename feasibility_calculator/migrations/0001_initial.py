    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_misc_ops_costs_per_hour_Rs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_equipment_ops_cost_per_hour_Rs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_labour_ops_cost_per_hour_Rs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_number_of_parts_produced_per_hour', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_cost_per_part_Rs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_size_required_m2', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('total_equip_size_reqs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('total_misc_size_reqs', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
