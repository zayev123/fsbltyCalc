...
class AvailableTechnology(models.Model):
    ...
    total_operating_cost_per_hour_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_size_required_m2 = models.DecimalField(default=0, max_digits=12,decimal_places=6)
    total_cost_per_part_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_number_of_parts_produced_per_hour = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_equipment_ops_cost_per_hour_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_labour_ops_cost_per_hour_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_misc_ops_costs_per_hour_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_equip_size_reqs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    total_misc_size_reqs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
...
class Equipment_Maintenance_Cost(models.Model):
    ...
    part_replacement_cost_per_unit_per_hour_Rs = models.DecimalField(default=0, max_digits=16,decimal_places=6)
    remarks = models.TextField(blank=True, null=True,)
    reference = models.FileField(upload_to='research_papers', blank=True, null=True, storage=OverwriteStorage())
