...
def manage_presave_equipment(original_equipment, changed_equipment, current_secProd):
    ...
    # these 2 places arewhere you can make changes to current technology
    # only when it is going from none to non none, that is when you need to remove it
    ...
    '''
        ...
        if current_tech.id == changed_equipment.technology.id:
...
def manage_presave_labour(original_labour, changed_labour, current_tech, current_secProd):
    ...
    if current_secProd != None and changed_labour.laboProductionSection != None and not current_secProd.id == changed_labour.laboProductionSection.id:
        old_sec_prod = current_secProd
        new_sec_prod = changed_labour.laboProductionSection
        # here, cost and size are changed
        ...
        old_sec_prod.save()
        new_sec_prod.save()
    elif current_secProd != None and changed_labour.laboProductionSection != None and current_secProd.id == changed_labour.laboProductionSection.id:
        ...
        current_secProd.save()
    elif current_secProd == None and changed_labour.laboProductionSection != None:
        new_sec_prod = changed_labour.laboProductionSection
        new_sec_prod.total_section_operating_cost_per_hour_Rs = new_sec_prod.total_section_operating_cost_per_hour_Rs + changed_labour.total_labourCost_per_hour_Rs
        new_sec_prod.save()
    elif current_secProd != None and changed_labour.laboProductionSection == None:
